...
<body>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 mb-3 text-center">
                                        ...
                                        <img src="{{ asset('/storage/products/'.$product->image) }}" class="preview-image" alt="Current Image">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Enter product description" maxlength="1000">{{ old('description', $product->description) }}</textarea>
                                        <div class="character-counter">
    ...
    <script>
        ...
        document.getElementById('productForm').addEventListener('submit', function(e) {
            ...
            submitBtn.innerHTML = '<span class="loading-spinner spinner-border spinner-border-sm me-2"></span>Updating...';
        });
